...
# Nemu (E -- Empty / Exhausted -- Earth -- Fidelity)
...
- **Element**: Earth -- stability, grounding, afternoon
- **Location affinity**: A kitchen bathed in afternoon light (warmth, centeredness, golden illumination)
- **Puruhani**: Exhausted (pot color: yellow, bera sticker: brown bear)
- **HENLO Letter**: E
