...
pot_color: green
bear_type: panda
character_partner: char-kaori
source_file: entities/puruhani/wood.md
source_commit: HEAD
tags: [kizuna, puruhani, wood]
cross_references:
  - char-kaori
  - elem-wood
---
...
Sentient honey creature created by the Ooga Booga Beras (OBB) from honey. Lives in a green clay pot with a Panda bera sticker. Paired with Kaori (Hopeful).
...
|----------|-------|
| Element | Wood -- mu |
| Virtue | Benevolence -- ren |
| HENLO Letter | H |
| Color | #C1C950 (Yellow-Green) |

## Design

Soft, golden, honey-colored blob. Same species as all Puruhani but with a Happy expression and pose. Characteristically sleepy -- drapes over the sides of its green clay pot. The pot has a lid/cap. "Just woke up from centuries of hibernation" energy.

## Pair Dynamic (with Kaori)
