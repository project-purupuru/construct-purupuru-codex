...
element: water
generation: kizuna
emotion_trait: Overwhelmed
pot_color: blue
bear_type: red panda
character_partner: char-ruan
source_file: entities/puruhani/water.md
source_commit: HEAD
tags: [kizuna, puruhani, water]
cross_references:
  - char-ruan
  - elem-water
---

# Water Puruhani (Overwhelmed)

*Name: Unknown (GAP-002)*

Sentient honey creature created by the Ooga Booga Beras (OBB) from honey. Lives in a blue clay pot with a Red Panda bera sticker. Paired with Ruan (Overstimulated).
...
Soft, golden, honey-colored blob. Same species as all Puruhani but with an Overwhelmed expression and pose. Characteristically sleepy -- drapes over the sides of its blue clay pot. The pot has a lid/cap. "Just woke up from centuries of hibernation" energy.

## Pair Dynamic (with Ruan)
