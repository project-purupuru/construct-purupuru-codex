...
source_commit: HEAD
tags: [kizuna, puruhani, fire]
cross_references:
  - char-akane
  - elem-fire
---

# Fire Puruhani (Nefarious)

*Name: Unknown (GAP-002)*

Sentient honey creature created by the Ooga Booga Beras (OBB) from honey. Lives in a red clay pot with a Black Bear bera sticker. Paired with Akane (Naughty).
...
Soft, golden, honey-colored blob. Same species as all Puruhani but with a Nefarious expression and pose. Characteristically sleepy -- drapes over the sides of its red clay pot. The pot has a lid/cap. "Just woke up from centuries of hibernation" energy.

## Pair Dynamic (with Akane)
